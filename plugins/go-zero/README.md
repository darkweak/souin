...
This is a distributed HTTP cache module for Go-zero based on [Souin](https://github.com/darkweak/souin) cache.  
...
See the [Souin](https://github.com/darkweak/souin) configuration for the full configuration, and its associated [development go-zero middleware](https://github.com/darkweak/souin/blob/master/plugins/go-zero)  
