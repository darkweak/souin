...
require (
	...
	github.com/darkweak/storages/olric v0.0.19
	github.com/darkweak/storages/otter v0.0.19
	github.com/darkweak/storages/redis v0.0.19
	github.com/darkweak/storages/simplefs v0.0.19
